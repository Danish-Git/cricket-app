...
class LoginController extends GetxController {
  ...
  void navigateToOTPScreen() => Get.toNamed(AppScreenConst.otpScreen,
      arguments: {'phoneNo': phoneNumber, 'isOTPScreen': true});
  ...
  void onVerifyClick() async {
    try {
      ...
      if (user != null) {
        ...
        prefs.setString('userNumber', phoneNumber!);
  ...
  String? validatePhoneNo(String? value) {
    if (value?.isEmpty ?? true) {
      return 'Please provide phone number';
        ...
        !(num.tryParse(value ?? 'null')?.isFinite ?? false)) {
